...
public class ReactorNettyCall implements Call {
  ...
  public Mono<Response> getExecutable() {
    return executable;
  }

  public void setExecutable(Mono<Response> responseMono) {
    this.executable = responseMono;
  }
}
