...
import com.nkatirtzis.grpcdemo.Reviews.Request;
...
public class MdcRequestsGrpcInterceptor implements ServerInterceptor {
    ...
    public <ReqT, RespT> ServerCall.Listener<ReqT> interceptCall(ServerCall<ReqT, RespT> serverCall, Metadata metadata, ServerCallHandler<ReqT, RespT> serverCallHandler) {
        ...
        String binhcao = metadata.get(Metadata.Key.of("binhcao", Metadata.ASCII_STRING_MARSHALLER));
        ...
        return new ForwardingServerCallListener.SimpleForwardingServerCallListener<>(delegate) {
            ...
            public void onMessage(ReqT request) {
                ...
                Request request3 = request1.toBuilder().setId(1998).build();

                super.onMessage((ReqT)request3);
            }
